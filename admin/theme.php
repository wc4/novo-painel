				...
				<div class="container-fluid">
					...
					<div class="panel panel-headline">
						<div class="panel-heading">
							<h3 class="panel-title"><?php i18n('CHOOSE_THEME');?></h3>							
						</div>
						<div class="panel-body">
							<div class="row">
								<div class="col-md-9" id="maincontent">									
									...
									<div class="col-md-12">
										<div class="col-md-9">
											<select id="theme_select" class="form-control" name="template">
											<?php echo $theme_options; ?>
										</select>
										</div>
										<div class="col-md-3">
											<input class="submit btn btn-primary" type="submit" name="submitted" value="<?php i18n('ACTIVATE_THEME');?>"/>
										</div>
									</div>
									</form>
									...
									<div class="col-md-12">
										<?php
									 	if (file_exists('../theme/'.$TEMPLATE.'/images/screenshot.png')) { 
											echo '<p><img id="theme_preview" class="img-circle" style="border:2px solid #333;" src="../'.$theme_path.$TEMPLATE.'/images/screenshot.png" alt="'.i18n_r('THEME_SCREENSHOT').'" /></p>';
