...
$theme_options .= '<select class="form-control" name="t" id="theme-folder">';	
...
$theme_templates .= '<span id="themefiles"><select class="form-control" id="theme_files" name="f">';
				...
				<div class="container-fluid">
					...
					<div class="panel panel-headline">
						<div class="panel-heading">
							<h3 class="panel-title"><?php i18n('EDIT_THEME'); ?></h3>							
						</div>
						<div class="panel-body">							
							<div class="row">
								<div class="col-md-9" id="maincontent">									
									<form action="<?php myself(); ?>" method="get" accept-charset="utf-8" class="row">
										<div class="col-md-5">
										...
										<div class="col-md-2">
											<input class="submit btn btn-primary" type="submit" name="s" value="<?php i18n('EDIT'); ?>" />
										</div>									
									</form>
									<hr>
									...
									<form action="<?php myself(); ?>?t=<?php echo $template; ?>&amp;f=<?php echo $template_file; ?>" method="post" >
										...
										<textarea name="content" class="form-control" id="codetext" wrap='off' ><?php echo htmlentities($content, ENT_QUOTES, 'UTF-8'); ?></textarea>
										<input type="hidden" value="<?php echo tsl($template) . $template_file; ?>" name="edited_file" />
										<?php exec_action('theme-edit-extras'); ?>
										<p id="submit_line" >
											<span><input class="submit btn btn-primary" type="submit" name="submitsave" value="<?php i18n('BTN_SAVECHANGES'); ?>" /></span> &nbsp;&nbsp;<?php i18n('OR'); ?>&nbsp;&nbsp; <a class="cancel" href="theme-edit.php?cancel"><?php i18n('CANCEL'); ?></a>
										</p>
									</form>
								</div>
								<div class="col-md-3">
