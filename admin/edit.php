...
<div class="main">
				...
				<div class="container-fluid">
					...
					<div class="panel panel-headline">
						<div class="panel-heading">
							<h3 class="panel-title"><?php if(isset($data_edit)) { i18n('PAGE_EDIT_MODE'); } else { i18n('CREATE_NEW_PAGE'); } ?></h3>							
						</div>
		...
		<form class="largeform" id="editform" action="changedata.php" method="post" accept-charset="utf-8" >
			...
			<p id="edit_window">
				...
				<input class="form-control" id="post-title" name="post-title" type="text" value="<?php echo $title; ?>" placeholder="<?php i18n('PAGE_TITLE'); ?>" />
			</p>
			...
			<div class="col-md-12">
				<div class="inline clearfix form-group col-md-4" id="post-private-wrap" >
					<label for="post-private" ><?php i18n('KEEP_PRIVATE'); ?>: &nbsp; </label>
					<select id="post-private" name="post-private" class="form-control input-sm" >
						<option value="" ><?php i18n('NORMAL'); ?></option>
						<option value="Y" <?php echo $sel_p; ?> ><?php echo ucwords(i18n_r('PRIVATE_SUBTITLE')); ?></option>
					</select>
				</div>
				<div class="inline clearfix form-group col-md-4">
					<label for="post-parent"><?php i18n('PARENT_PAGE'); ?>:</label>
					<select class="form-control input-sm" id="post-parent" name="post-parent"> 
						<?php 
						getPagesXmlValues();
						$count = 0;
				...
				<div class="inline clearfix form-group col-md-4">
					...
					<select class="form-control input-sm" id="post-template" name="post-template" >
						<?php echo $theme_templates; ?>
					</select>
				</div>
				
				<div class="inline post-menu clearfix form-group">
				...
				<div id="menu-items">
					<div class="inline clearfix col-md-8">
						<label for="post-menu"><?php i18n('MENU_TEXT'); ?></label>
						<input class="form-control input-sm" id="post-menu" name="post-menu" type="text" value="<?php echo $menu; ?>" />
					</div>
					<div class="inline clearfix form-group col-md-4">
						<label for="post-menu-order"><?php i18n('PRIORITY'); ?></label>
						<img src="template/images/tick.png" id="tick" />
						<select class="form-control input-sm" id="post-menu-order" name="post-menu-order" >
			...
			<div class="col-md-12">
				<div class="inline clearfix form-group col-md-6">
					<label for="post-id"><?php i18n('SLUG_URL'); ?>:</label>
					<input class="form-control input-sm" type="text" id="post-id" name="post-id" value="<?php echo $url; ?>" <?php echo ($url=='index'?'disabled="disabled" ':''); ?>/>
					<label for="post-metak"><?php i18n('TAG_KEYWORDS'); ?>:</label>
					<input class="form-control input-sm" id="post-metak" name="post-metak" type="text" value="<?php echo $metak; ?>" />
				</div>
				...
				<div class="inline clearfix form-group col-md-6">
					...
					<textarea class="form-control input-sm" id="post-metad" name="post-metad" rows="4"><?php echo $metad; ?></textarea>
				</div>
