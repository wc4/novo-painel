...
?>
  <h3 class="col-md-12"><?php echo i18n_r('i18n_search/CONFIGURATION'); ?></h3>
	<div class="edit-nav col-md-12" >
    <p>
      <a class="btn btn-primary btn-xs" href="<?php echo $link; ?>&view=usage" <?php echo $view=='usage' ? 'class="current"' : ''; ?> ><?php echo i18n_r('i18n_search/VIEW_USAGE'); ?></a>
      <a class="btn btn-primary btn-xs" href="<?php echo $link; ?>&view=settings" <?php echo $view=='settings' ? 'class="current"' : ''; ?> ><?php echo i18n_r('i18n_search/VIEW_SETTINGS'); ?></a>
    </p>
    <div class="clear" ></div>
  </div>
<?php if ($view == 'settings') { ?>
  <form method="post" id="searchForm" action="<?php echo $link; ?>" style="clear:both">
    <table id="editsearch" class="table table-bordered">
      <tbody>
        ...
        <tr><td><?php i18n('i18n_search/CONTENT_WEIGHT'); ?></td><td colspan="2"><input type="text" name="contentWeight" value="<?php echo htmlspecialchars(@$params['contentWeight']); ?>" class="form-control input-sm"/></td></tr>
        <tr><td><?php i18n('i18n_search/TITLE_WEIGHT'); ?></td><td colspan="2"><input type="text" name="titleWeight" value="<?php echo htmlspecialchars(@$params['titleWeight']); ?>" class="form-control input-sm"/></td></tr>
        <tr><td><?php i18n('i18n_search/TAG_WEIGHT'); ?></td><td colspan="2"><input type="text" name="tagWeight" value="<?php echo htmlspecialchars(@$params['tagWeight']); ?>" class="form-control input-sm"/></td></tr>
        <tr>
          <td><?php i18n('i18n_search/TAG_MODE'); ?></td>
          <td colspan="2">
            <select name="tagMode" class="form-control input-sm">
        ...
        <tr><td><?php i18n('i18n_search/MIN_TAG_SIZE'); ?></td><td><input type="text" name="minTagSize" value="<?php echo htmlspecialchars(@$params['minTagSize']); ?>" class="form-control input-sm"/></td><td>(minTagSize)</td></tr>
        <tr><td><?php i18n('i18n_search/MAX_TAG_SIZE'); ?></td><td><input type="text" name="maxTagSize" value="<?php echo htmlspecialchars(@$params['maxTagSize']); ?>" class="form-control input-sm"/></td><td>(maxTagSize)</td></tr>
        ...
        <tr><td><?php i18n('i18n_search/MAX'); ?></td><td><input type="text" name="max" value="<?php echo @$params['max']; ?>" class="form-control input-sm"/></td><td>(max)</td></tr>
        <tr><td><?php i18n('i18n_search/NUM_WORDS'); ?></td><td><input type="text" name="numWords" value="<?php echo @$params['numWords']; ?>" class="form-control input-sm"/></td><td>(numWords)</td></tr>
        ...
        <tr><td><?php i18n('i18n_search/TRANSLITERATION'); ?></td><td><textarea name="transliteration" class="form-control input-sm"><?php echo htmlspecialchars(@$params['transliteration']); ?></textarea></td><td></td></tr>
      </tbody>
    </table>
...
<?php } else { ?>
      ...
      <p><?php i18n('i18n_search/USAGE_IN_PAGE'); ?></p>
        <code class="col-md-12">(% searchform %)<br/>(% searchresults %)</code>
        <p><?php i18n('i18n_search/USAGE_IN_TEMPLATE'); ?></p>
        <code class="col-md-12">&lt;?php get_i18n_search_form(array('slug'=>'search')); ?&gt;</code>
        ...
        <code class="col-md-12">(% searchresults max:20 showLanguage:0 DATE_FORMAT:"%A, %d.%m.%Y - %H:%M" %)</code>
        <p><?php i18n('OR'); ?></p>
