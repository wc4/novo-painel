...
?>
    ...
    <table id="editspecial" class="table table-bordered">
      <thead>
        <tr>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td class="secondarylink">
            <a href="edit.php?special=<?php echo $def['name']; ?>" title="<?php echo i18n_r('CREATE_NEW_PAGE').': '.$def['title']; ?>"><span class="lnr lnr-file-add"></span></a>
          </td>
        </tr>
        <?php } ?>
      </body>
...
?>
        ...
        <p>
          <a href="<?php echo $link; ?>&view=creDate" class="btn btn-primary btn-xs" <?php echo $view=='creDate' ? 'class="current"' : ''; ?> ><?php i18n('i18n_specialpages/VIEW_CREDATE'); ?></a>
          <a href="<?php echo $link; ?>&view=pubDate" class="btn btn-primary btn-xs" <?php echo $view=='pubDate' ? 'class="current"' : ''; ?> ><?php i18n('i18n_specialpages/VIEW_PUBDATE'); ?></a>
          <a href="<?php echo $link; ?>&view=title" class="btn btn-primary btn-xs" <?php echo $view=='title' ? 'class="current"' : ''; ?> ><?php i18n('i18n_specialpages/VIEW_TITLE'); ?></a>
        </p>
      ...
      <p style="margin-top: 5px;">
          <?php if ($is31) { ?>
          <?php } else { ?>
          <input type="checkbox" id="show-characters" value="" />
          <?php } ?>
          <input type="text" id="filter" value="" class="form-control" title="<?php i18n('i18n_specialpages/FILTER_TITLE'); ?>" placeholder="Filtrar, exemplo: Apartamento, casa, locação, venda, temporada, entre outros... "/>
        </p>

			<table id="editpages" class="table table-bordered">
      ...
      <p>
        <a href="edit.php?special=<?php echo $special; ?>" class="btn btn-primary"><?php i18n('CREATE_NEW_PAGE'); ?></a>
        &nbsp;<?php i18n('OR'); ?>&nbsp;
