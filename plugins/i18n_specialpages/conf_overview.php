  ...
  <table id="editspecial" class="table table-bordered">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td class="secondarylink"><a href="<?php echo $link; ?>&amp;edit&amp;copy=<?php echo urlencode($def['name']); ?>" title="<?php echo i18n_r('i18n_specialpages/COPY_PAGETYPE').htmlspecialchars($def['title']); ?>"><span class="lnr lnr-layers"></span></a>
        <td class="delete"><a href="<?php echo $link; ?>&amp;delete=<?php echo urlencode($def['name']); ?>" title="<?php echo i18n_r('i18n_specialpages/DELETE_PAGETYPE').htmlspecialchars($def['title']); ?>"><span class="lnr lnr-trash"></span></a>
      </tr>
      <?php } ?>
    </body>
  </table> 
