...
<div class="edit-nav tab-links col-md-12">  
    <?php if ($issearch) { ?>
    <a href="#tab-search" class="btn btn-primary btn-xs"><?php i18n('i18n_specialpages/TAB_SEARCH'); ?></a>
    <?php } ?>
    <a href="#tab-view" class="btn btn-primary btn-xs"><?php i18n('i18n_specialpages/TAB_VIEW'); ?></a>
    <a href="#tab-fields" class="btn btn-primary btn-xs"><?php i18n('i18n_specialpages/TAB_FIELDS'); ?></a>
    <a href="#tab-general" class="btn btn-primary btn-xs"><?php i18n('i18n_specialpages/TAB_GENERAL'); ?></a>  
  <div class="clear" ></div>
</div>  
...
<form method="post" id="specialpagesForm" action="load.php?id=i18n_specialpages&amp;config&amp;edit=<?php echo $name; ?>">
  ...
  <div id="tab-general" class="tab">
    <p class="col-md-12 text-success"><?php i18n('i18n_specialpages/CONFIG_EDIT_GENERAL_DESCR'); ?></p>
    <p><input type="text" class="form-control" name="post-title" value="<?php echo @$def['title']; ?>" /></p>
    <table id="editsp" class="table table-bordered">
      <tr>
        <td class="col-md-6"><label for="post-name"><?php i18n('i18n_specialpages/NAME'); ?></label> <small><?php i18n('i18n_specialpages/NAME_DESCR'); ?></small></td>
        <td class="col-md-6"><input type="text" class="form-control input-sm" id="post-name" name="post-name" value="<?php echo htmlspecialchars(@$def['name']); ?>" /></td>         
      </tr>
      <tr>
        <td class="col-md-6"><label for="post-slug"><?php i18n('SLUG_URL'); ?></label> <small><?php i18n('i18n_specialpages/SLUG_URL_DESCR'); ?></small></td>
        <td class="col-md-6"><input type="text" class="form-control input-sm" id="post-slug" name="post-slug" value="<?php echo htmlspecialchars(@$def['slug']); ?>" /></td>         
      </tr>
      <tr>
        <td class="col-md-6"><label for="post-parent"><?php i18n('PARENT_PAGE'); ?></label> <small><?php i18n('i18n_specialpages/PARENT_PAGE_DESCR'); ?></small></td>
        <td class="col-md-6">
          <select id="post-parent" name="post-parent" class="form-control input-sm">
            <option value=""></option>
      ...
      <tr>
        <td class="col-md-6"><label for="post-tags"><?php i18n('TAG_KEYWORDS'); ?></label> <small><?php i18n('i18n_specialpages/TAG_KEYWORDS_DESCR'); ?></small></td>
        <td class="col-md-6"><input type="text" class="form-control input-sm" id="post-tags" name="post-tags" value="<?php echo htmlspecialchars(@$def['tags']); ?>" /></td>         
      </tr>
      <tr>
        <td class="col-md-6"><label for="post-template"><?php i18n('TEMPLATE'); ?></label> <small><?php i18n('i18n_specialpages/TEMPLATE_DESCR'); ?></small></td>
        <td class="col-md-6">
          <select id="post-template" name="post-template" class="form-control input-sm">
            <option value=""></option>
      ...
      <tr>
        <td class="col-md-6"><label for="post-menu"><?php i18n('i18n_specialpages/MENU'); ?></label> <small><?php i18n('i18n_specialpages/MENU_DESCR'); ?></small></td>
        <td class="col-md-6">
          <select id="post-menu" name="post-menu" class="form-control input-sm">
            <option value=""></option>
  ...
  <div id="tab-fields" class="tab" style="display:none;">
    <p class="col-md-12 text-success"><?php i18n('i18n_specialpages/CONFIG_EDIT_FIELDS_DESCR'); ?></p>
    <table id="editfields" class="table table-bordered">
      <thead>
        <tr>
  ...
  <?php
    ...
    ?> 
        <tr>
          <td colspan="5"><a href="#" class="add btn btn-default btn-sm"><i class="fa fa-plus-square"></i> <?php i18n('i18n_specialpages/ADD_FIELD'); ?></a></td>
  ...
  <div id="tab-view" class="tab" style="display:none;">
    <p class="col-md-12 text-success"><?php i18n('i18n_specialpages/CONFIG_EDIT_VIEW_DESCR'); ?></p>
    <div class="compdiv">      
      <textarea id="post-headercomponent" name="post-headercomponent" class="form-control" rows="10" placeholder="<?php i18n('i18n_specialpages/HEADERCOMPONENT'); ?>"><?php echo htmlspecialchars(@$def['headercomponent']); ?></textarea><br>
    </div>
    <div class="compdiv i18n-sp-comp">
      ...
      <div class="i18n-sp-wrapper" id="showcomponent" style="clear:both;">
        <textarea id="post-showcomponent" name="post-showcomponent" class="form-control" rows="10" placeholder="<?php i18n('i18n_specialpages/SHOWCOMPONENT'); ?>"><?php echo htmlspecialchars(@$def['showcomponent']); ?></textarea>
      </div>
  ...
  <div id="tab-search" class="tab" style="display:none;">
    <p class="col-md-12 text-success"><?php i18n('i18n_specialpages/CONFIG_EDIT_SEARCH_DESCR'); ?></p>
    <div class="compdiv i18n-sp-comp">
      <?php if ($isi18n && $languages) { ?>
        <div class="i18n-sp-langsel">
      ...
      <div class="i18n-sp-wrapper" id="searchcomponent" style="clear:both;">
        <textarea id="post-searchcomponent" name="post-searchcomponent" class="form-control" rows="10" placeholder="<?php i18n('i18n_specialpages/SEARCHCOMPONENT'); ?>"><?php echo htmlspecialchars(@$def['searchcomponent']); ?></textarea>
      </div>
      <?php if ($isi18n && $languages) foreach ($languages as $lang) { ?>
  ...
  <?php } ?>
  <br>
  <input type="submit" name="save" value="<?php i18n('i18n_specialpages/SAVE'); ?>" class="btn btn-primary submit"/>
  &nbsp;&nbsp; <?php i18n('OR'); ?> &nbsp;&nbsp;
...
?>
      <tr class="<?php echo $class; ?>">
        <td><input type="text" class="form-control input-sm" name="cf_<?php echo $i; ?>_name" value="<?php echo htmlspecialchars(@$def['name']); ?>"/></td>
        <td><input type="text" class="form-control input-sm" name="cf_<?php echo $i; ?>_label" value="<?php echo htmlspecialchars(@$def['label']); ?>"/></td>
        <td>
          <select name="cf_<?php echo $i; ?>_type" class="form-control input-sm">
          ...
          <textarea class="form-control input-sm" rows="10" style="width:150px;height:50px;padding:2px;<?php echo !$isdropdown ? 'display:none' : ''; ?>" name="cf_<?php echo $i; ?>_options"><?php echo htmlspecialchars($options); ?></textarea> 
        </td>
        <td>
          <input type="text" class="form-control input-sm" style="padding:2px;<?php if (@$def['type']=='textarea' || @$def['type']=='wysiwyg') echo 'display:none'; ?>" name="cf_<?php echo $i; ?>_value" value="<?php echo htmlspecialchars(@$def['value']); ?>"/>
...
<?php if ($issearch) { ?>
        <td>
          <select name="cf_<?php echo $i; ?>_index" class="form-control input-sm" style="width:65px;padding:2px;<?php if (!$indexable) echo 'display:none;'; ?>" >
...
<?php } ?>
        <td class="delete"><a href="#" class="delete" title="<?php i18n('i18n_specialpages/DELETE_FIELD'); ?>"><span class="lnr lnr-trash"></span></a></td>
      </tr>
<?php 
}
